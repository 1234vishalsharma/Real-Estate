...
export default function About() {
  return (
    <div className="flex justify-evenly items-center h-full w-full gap-8 pt-36">
      ...
      <div className='h-96 w-2/4 flex flex-col gap-8'>
        <Typography variant={"h3"} style={{'textAlign' : 'center' , 'textDecoration':'underline'}}>About Us</Typography>
